...
const liveSessions = [
    { id: '1', title: 'Live Q&A: Advanced React State Management', description: 'Join our expert instructor for a live Q&A session on advanced state management patterns in React.', scheduledTime: '2024-08-15T14:00:00Z', isFree: false },
    ...
    { id: '3', title: 'Community Hangout: Tech Talk & Networking', description: 'A casual, free-for-all session to discuss the latest in tech and meet fellow learners.', scheduledTime: '2024-08-22T18:00:00Z', isFree: false },
...
function SessionCard({ session }: { session: (typeof liveSessions)[0] }) {
  ...
  return (
    <Card className="flex flex-col relative">
      ...
      <CardHeader>
        <CardTitle className="font-headline pr-12">{session.title}</CardTitle>
